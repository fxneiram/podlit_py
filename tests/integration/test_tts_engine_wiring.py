...
def test_audio_video_generator_drives_the_real_coqui_adapter(tmp_path):
    ...
    with (
        ...
        tts_engine = CoquiTTSAdapter(voices_dir=str(tmp_path))
        ...
        assert call_kwargs["speaker_wav"] == f"{tmp_path}/narrator.wav"
